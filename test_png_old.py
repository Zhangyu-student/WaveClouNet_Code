...
from dataset import  MultipleDataset
...
"""
此代码旨在复现其他论文针对Sen2_Multi_Old的指标对比方式
"""
...
if __name__ == "__main__":
    # 配置参数
    config = {
        "model_path": r"D:\研究生\论文代码\paper3\checkpoints\model_epoch_100.pth",
        # "model_path": r"E:\研究生\研究生科研学习\paper3\checkpoints\loss_ablation\Sen_Old\train_logs_old_l1_spec_loss.pth",
        "data_root": r"E:/多时相云修复数据集",
        "save_dir": "./inference_results/old/inference_results_old_retrain",
        "batch_size": 8,
